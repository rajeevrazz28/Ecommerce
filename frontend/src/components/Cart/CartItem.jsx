        ...
        <div className="flex flex-col gap-3 py-5 pl-2 sm:pl-6 border-b overflow-hidden" key={product}>
            ...
            <div className="flex justify-between pr-4 sm:pr-0 sm:justify-start sm:gap-6">
                ...
                <div className="flex gap-1 items-center">
                    <button onClick={() => decreaseQuantity(product, quantity)} className="w-7 h-7 text-3xl font-light bg-gray-50 rounded-full border flex items-center justify-center cursor-pointer"><p>-</p></button>
                    ...
                    <button onClick={() => increaseQuantity(product, quantity, stock)} className="w-7 h-7 text-xl font-light bg-gray-50 rounded-full border flex items-center justify-center cursor-pointer">+</button>
                </div>
                {/* <!-- quantity --> */}
                {inCart && (
                    <>
