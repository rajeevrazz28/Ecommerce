        ...
        <>
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    {/* <!-- sidebar column  --> */}
                    <div className="loginSidebar bg-primary-mist  p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5">
                        <button className="font-medium text-primary-black text-3xl">Login</button>
                        <button className="text-primary-black text-lg">Get access to your Orders, Wishlist and Recommendations</button>
                    </div>
                    {/* <!-- sidebar column  --> */}
                            ...
                            <form onSubmit={handleLogin}>
                                <div className="flex flex-col w-full gap-4">
                                    ...
                                    <div className="flex flex-col gap-2.5 mt-2 mb-32">
                                        ...
                                        <button type="submit" className="text-white py-3 w-full bg-primary-black shadow hover:shadow-lg rounded-sm font-medium">Login</button>
