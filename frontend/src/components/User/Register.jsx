    ...
    const handleDataChange = (e) => {
        if (e.target.name === "avatar") {
            ...
            if (files && files.length > 0) {
                ...
                // Handle the case where no file is selected (cancelled or closed without choosing)
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-primary-black shadow hover:shadow-lg rounded-sm font-medium">Signup</button>
                                <Link to="/login" className="text-primary-blue text-center py-3 w-full font-medium">Existing User? Log in</Link>
