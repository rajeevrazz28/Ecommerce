            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-mist px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        <h1 className="font-medium text-primary-black text-3xl">Looks like you're new here!</h1>
                        <p className="text-primary-black text-lg pr-2">Sign up with your mobile number to get started</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <div className="flex flex-col w-full justify-between sm:flex-row gap-3 items-center">
                                    ...
                                    />
                                    <label className="rounded font-medium bg-primary-mist text-center cursor-pointer text-primary-blue w-3/4 py-2 px-2.5 shadow hover:shadow-lg">
                                        <input
                                            type="file"
                                            name="avatar"
                                            accept="image/*"
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-primary-black shadow rounded-sm font-medium hover:shadow-lg">Update</button>
                                <Link className=" text-primary-blue text-center py-3 w-full font-medium" to="/account">Cancel</Link>
                            </div>
